...
from symptom.file_utils import ensure_dir
from symptom.initial_watcher import SymptomInitialWatcher
from symptom.followup_watcher import SymptomFollowupWatcher
...
def main():
    ...
    print()
    print("=" * 60)
    print("[INFO] symptom 패키지 시작")
    print("[INFO] symptom 입력 폴더: {}".format(INPUT_DIR))
    print("[INFO] symptom 초안 폴더: {}".format(DRAFT_DIR))
    ...
    initial_watcher = SymptomInitialWatcher(
        input_dir=INPUT_DIR,
        done_dir=DONE_DIR,
        draft_dir=DRAFT_DIR,
    ...
    followup_watcher = SymptomFollowupWatcher(
